...
const navigation = [
  ...
  { name: "Frota & Logística", href: "/frota-logistica" },
      ...
      <nav className="container-custom h-header flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center space-x-3">
          ...
          <div>
            ...
            <div className="text-xs text-muted-foreground">Ferro & Aço</div>
          </div>
        </Link>
        ...
        <button
          ...
          className="lg:hidden p-2 rounded-lg hover:bg-secondary transition-colors focus-ring"
